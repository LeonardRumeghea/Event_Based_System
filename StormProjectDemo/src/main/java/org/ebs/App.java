...
public class App
{
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        SplitTextBolt textBolt = new SplitTextBolt();
...
//    	builder.setBolt(SPLIT_BOLT_ID, textBolt).shuffleGrouping(SPOUT_ID);
    	builder.setBolt(SPLIT_BOLT_ID, textBolt, 2).setNumTasks(4).shuffleGrouping(SPOUT_ID);
//    	builder.setBolt(SPLIT_BOLT_ID, textBolt, 2).setNumTasks(4).allGrouping(SPOUT_ID);
//      builder.setBolt(SPLIT_BOLT_ID, textBolt, 2).setNumTasks(4).customGrouping(SPOUT_ID, new MyGrouping());
